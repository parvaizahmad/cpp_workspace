 ...
 * 
 * Problem Statement:
 * In this exercise you will create a program that will be used in a digital library to format and sort journal 
 * entries based on the authors last name. 
 ...
 * Do not forget to also remove the whitespace so that the string variable journal_entry_1 will then contain the string "Newton" 
 * with no whitespaces.
...
int main(int argc, char **argv)
{
    ...
    journal_entry_1 = journal_entry_1.erase(0, journal_entry_1.find(" ") + 1);
